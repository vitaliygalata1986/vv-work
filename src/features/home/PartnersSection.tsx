...
import { featuredPartners } from '../../data/catalog'
  ...
  return (
    ...
    >
      <div className="page-container section-spacing">
        ...
        <ul className="mt-8 grid gap-4 lg:mt-10 lg:grid-cols-3 lg:gap-5">
            ...
            <li key={partner.slug}>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <span
                    aria-hidden="true"
                    className={`flex size-15 items-center justify-center rounded-2xl text-2xl font-extrabold tracking-tight ${logoStyles[index]}`}
                  >
                    {partner.initials}
                  </span>
                  <Icon
